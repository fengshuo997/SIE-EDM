...
matchname_example = ['Supply temp', 'HVAC KN2']
query_time_example = {'timestamp':'2021/8/14 11:49','range':['2021/8/14 9:00','2021/8/14 23:00']}



columns = ['DATE', 'TIMESTAMP', 'LOCATION', 'ENERGY_SOURCE', 'MEASURE', 'UNIT_OF_MEASURE', 'INTERVAL', 'VALUE']  # only temporary need to change!!!!
example_column_structure = [['ENERGY_SOURCE', 'MEASURE'], ['INTERVAL', 'LOCATION', 'UNIT_OF_MEASURE', 'DATE', 'VALUE', 'TIMESTAMP']]  # only temporary need to change!!!!
